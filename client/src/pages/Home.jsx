            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
                <div className="text-center">
                    ...
                    <p className="mt-4 max-w-2xl text-xl text-gray-400 mx-auto mb-10">
                        ...
                        <strong className="text-gray-200">Zero-Knowledge Proofs</strong> for integrity,{" "}
                ...
                <div id="features" className="mt-32 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="glass-card p-6 animate-slide-up" style={{ animationDelay: "0ms" }}>
                        ...
                        <h3 className="section-title">Zero-Knowledge Proofs</h3>
                        <p className="text-gray-400 text-sm">
                            Prove you possess the correct attribute keys and file hash preimages to the Groth16 verifier contract without revealing them.
                        </p>
                    </div>

  ...
  return (
    <div>
      ...
      <div className="animate-section">
        <h2 className="animate-heading">What is BlockShare ?</h2>
        <p className="animate-para">
          BlockShare is a decentralized file storage system that uses
          ...
          BlockShare, data management becomes decentralized and transparent, a
      ...
      <div className="footer-section">
        <div className="column1">
          <h2 className="column1-heading"></h2>
          <p className="column1-para"></p>
        </div>

        <div className="column2">
          <h2 className="column2-text"></h2>
